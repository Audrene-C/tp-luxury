 ...
 */
final class Version20200723132015 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE candidate CHANGE job_category job_category INT DEFAULT NULL, CHANGE gender gender VARCHAR(255) DEFAULT \'NULL\', CHANGE passport_file passport_file VARCHAR(255) DEFAULT NULL, CHANGE pourcentage pourcentage INT DEFAULT 0 NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE candidate_id candidate_id INT DEFAULT NULL, CHANGE job_offer_id job_offer_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE candidate CHANGE job_category job_category INT DEFAULT NULL, CHANGE gender gender VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'\'\'NULL\'\'\' COLLATE `utf8mb4_unicode_ci`, CHANGE passport_file passport_file VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE pourcentage pourcentage INT DEFAULT NULL');
        $this->addSql('ALTER TABLE client CHANGE job_category job_category INT DEFAULT NULL');
        $this->addSql('ALTER TABLE file CHANGE candidate_id candidate_id INT DEFAULT NULL');
